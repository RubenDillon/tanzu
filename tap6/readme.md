...
```
	1. Change the ootb_suply_chain_testing_Scanning to accept Pull Request. For that replace the current with the following
...
ootb_supply_chain_testing_scanning:
  ...
  service_account: default    
	...
	5. That button direct you to the github request and you need to merge that request
